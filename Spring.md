...
3. Install an IDE (e.g intellij , Netbeans , Eclipse and etc.). Netbeans and Eclipse is much better. Eclipse is open sourse. The rest of the settings up is based on Eclipse Neon.
...
5. Install a Web server(e.g Apache Tomcat). We use Tomcat (8.0.37).
    ...
    - add it to eclipse 
      - menue Window -> show view -> other -> type server and select it.
