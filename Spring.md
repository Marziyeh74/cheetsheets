...
مثال سوم : 
 ...
 اما سوال این جاست که در این مثال آخر هم بالاخره در جایی از کد خارج از application باید وابستگی به شی به صورت hard code تامین شود. یعنی ما در متد main اگر بخواهیم هر تعداد شی دیگری new کنیم باید تعداد خطوطی مشابه اضافه کنیم.
